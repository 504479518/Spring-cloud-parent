package com.caesar.common.constant;
...
public interface SecurityConstants {
    ...
    String LOGOUT_PATH = "/cloud-auth/oauth/logout";

    /**
     * 新增菜单路径,新增不存在的路由会导致系统无法访问，线上禁止新增菜单的操作
     */
    String SAVE_MENU_PATH = "/cloud-admin/api/v1/menus";
     ...
     * 系统管理 web 客户端ID
     */
    String ADMIN_CLIENT_ID = "cloud-admin-web";

    /**
     * 移动端（H5/Android/IOS）客户端ID
     */
    String APP_CLIENT_ID = "cloud-app";

    /**
     * 小程序端（微信小程序、....） 客户端ID
     */
    String WEAPP_CLIENT_ID = "cloud-weapp";
