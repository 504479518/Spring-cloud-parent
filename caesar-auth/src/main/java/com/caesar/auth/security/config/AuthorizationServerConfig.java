package com.caesar.auth.security.config;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.http.HttpStatus;
import cn.hutool.json.JSONUtil;
import com.caesar.auth.security.core.clientdetails.ClientDetailsServiceImpl;
import com.caesar.auth.security.core.userdetails.user.SysUserDetails;
import com.caesar.auth.security.core.userdetails.user.SysUserDetailsServiceImpl;
import com.caesar.auth.security.extension.captcha.CaptchaTokenGranter;
import com.caesar.auth.security.extension.mobile.SmsCodeTokenGranter;
import com.caesar.auth.security.extension.refresh.PreAuthenticatedUserDetailsService;
import com.caesar.auth.security.extension.wechat.WechatTokenGranter;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public DefaultTokenServices tokenServices(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        clientUserDetailsServiceMap.put(SecurityConstants.APP_CLIENT_ID, null); //TODO Android、IOS、H5 移动客户端
        clientUserDetailsServiceMap.put(SecurityConstants.WEAPP_CLIENT_ID, null); //TODO 微信小程序客户端
